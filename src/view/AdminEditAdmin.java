...
public class AdminEditAdmin implements ActionListener {
    JFrame frame = new JFrame("Admin --> Edit Admin");
    ...
    JPasswordField adminPassword = new JPasswordField(AdminManager.getInstance().getPassword());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (command) {
            case "Submit":
                ...
                ControllerDatabase.deleteAdmin(admin);
